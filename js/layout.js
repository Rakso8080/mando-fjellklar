(function () {
  ...
  MO.injectLayout = function (activePage) {
    ...
    var navHTML = [
      ...
      '<button class="catbar__btn active" data-i18n="cat.alle">Alle</button>',
      '<button class="catbar__btn" data-i18n="cat.jakker">Jakker &amp; Yttertøy</button>',
      '<button class="catbar__btn" data-i18n="cat.mellomlag">Mellomlag</button>',
      '<button class="catbar__btn" data-i18n="cat.bukser">Bukser</button>',
      '<button class="catbar__btn" data-i18n="cat.sko">Sko &amp; Støvler</button>',
      '<button class="catbar__btn" data-i18n="cat.tilbehor">Tilbehør</button>',
      '<button class="catbar__btn" data-i18n="cat.tilbud">🔥 Tilbud</button>',
      '</div></div>',
    ].join('');
